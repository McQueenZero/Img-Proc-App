...
class Ui_MainWindow(QtWidgets.QMainWindow):
    ...
    def setupUi(self, MainWindow):
        ...
        self.action9_21 = QtWidgets.QAction(MainWindow)
        self.action9_21.setObjectName("action9_21")
        ...
        self.action21_9 = QtWidgets.QAction(MainWindow)
        self.action21_9.setObjectName("action21_9")
        ...
        self.menu_7.addAction(self.action9_21)
        self.menu_7.addAction(self.action9_16)
        self.menu_7.addAction(self.action10_16)
        ...
        self.menu_7.addAction(self.action16_10)
        self.menu_7.addAction(self.action16_9)
        self.menu_7.addAction(self.action21_9)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.action9_21.setText(_translate("MainWindow", "9:21"))
        ...
        self.action21_9.setText(_translate("MainWindow", "21:9"))
    ...
    def connectUi(self, MainWindow):
        ...
        self.action9_21.triggered.connect(lambda: self.crop(9 / 21))
        self.action9_16.triggered.connect(lambda: self.crop(9 / 16))
        self.action10_16.triggered.connect(lambda: self.crop(10 / 16))
        ...
        self.action16_10.triggered.connect(lambda: self.crop(16 / 10))
        self.action16_9.triggered.connect(lambda: self.crop(16 / 9))
        self.action21_9.triggered.connect(lambda: self.crop(21 / 9))
